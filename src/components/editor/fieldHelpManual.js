...
export const FIELD_HELP_MANUAL = {
  slug:
    'Имя папки процесса в формате kebab-case на латинице (как в `NN-my-process-name`). Используется как часть логического пути домена в API. Без пробелов и кириллицы; дефисы допустимы.',

  editor: {
    domain:
      'Домен (L1) — верхний уровень в дереве процессов компании. Новый L2/L3/SOP будет создан внутри выбранного домена.',
    level:
